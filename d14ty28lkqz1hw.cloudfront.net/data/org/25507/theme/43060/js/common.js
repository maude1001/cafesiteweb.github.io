...
$(document).ready(function(){
    ...
    else $("."+pathname[3]).addClass("active");
  ...
  arrows: true,
  slidesToShow: 4,
   nextArrow: '<div class="slick-arrow-left"><img src="//s3-ap-southeast-1.amazonaws.com/assets-powerstores-com/data/org/25507/theme/43060/img/Slider.png"></div>',
    
          prevArrow: '<div class="slick-arrow-right"><img src="//s3-ap-southeast-1.amazonaws.com/assets-powerstores-com/data/org/25507/theme/43060/img/Slider1.png"></div>',
...
$(document).ready(function() {
    if(window.location.href.match('/blogs/')){
        $(".salaberry-de-valleyfield-coffee-art-shop-blog").addClass("active");
    }
});
